...
import type { ReadReposApiV1ReposGetData, ReadReposApiV1ReposGetResponses, GetRepoApiV1ReposRepoNameGetData, GetRepoApiV1ReposRepoNameGetResponses, GetRepoApiV1ReposRepoNameGetErrors, GetDirContentApiV1ReposRepoNameTreeBranchDirNamesGetData, GetDirContentApiV1ReposRepoNameTreeBranchDirNamesGetResponses, GetDirContentApiV1ReposRepoNameTreeBranchDirNamesGetErrors, GetFileContentApiV1ReposRepoNameBlobBranchFileNameGetData, GetFileContentApiV1ReposRepoNameBlobBranchFileNameGetResponses, GetFileContentApiV1ReposRepoNameBlobBranchFileNameGetErrors, RootGetData, RootGetResponses } from './types.gen';
 ...
 * Get Repo
 */
export const getRepoApiV1ReposRepoNameGet = <ThrowOnError extends boolean = false>(options: Options<GetRepoApiV1ReposRepoNameGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetRepoApiV1ReposRepoNameGetResponses, GetRepoApiV1ReposRepoNameGetErrors, ThrowOnError>({
        responseType: 'json',
